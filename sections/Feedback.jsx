      ...
      <motion.div 
        ...
        >
          ...
          >
            ...
            <div>
              <h4 className="font-boldsm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Felix Chukwu</h4>
            ...
            <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
              ...
              MetaVerse is very useful for today's work or can be called web 3.0. 
              You can use Metaverse in any sphere of Life.
            </p>
          </motion.div>
          <motion.div
